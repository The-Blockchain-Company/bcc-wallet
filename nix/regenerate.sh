...
# Regenerate materialized tbco-nix-utils in ./materialized
$(nix-build "$nix" -A tbco-nix-utils.regenerateMaterialized --no-out-link)/bin/regenerate-materialized-nix
