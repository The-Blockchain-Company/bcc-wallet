{
  ...
  extras = hackage:
    { packages = { tbco-nix-utils = ./.plan.nix/tbco-nix-utils.nix; }; };
  modules = [
    ({ lib, ... }:
      { packages = { "tbco-nix-utils" = { flags = {}; }; }; })
    ({ lib, ... }:
      {
        packages = {
          ...
          "tbco-nix-utils".components.exes."rewrite-libs".planned = lib.mkOverride 900 true;
          ...
          "tbco-nix-utils".components.exes."set-git-rev".planned = lib.mkOverride 900 true;
          ...
          "tbco-nix-utils".components.library.planned = lib.mkOverride 900 true;
