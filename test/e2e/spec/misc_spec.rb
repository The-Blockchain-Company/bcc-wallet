RSpec.describe BccWallet::Misc do

  describe BccWallet::Misc::Network do
  ...
  describe BccWallet::Misc::Utils do
    ...
    it "Inspect Sophie stake address" do
    ...
    it "Inspect Cole Icarus address" do
  ...
  describe BccWallet::Misc::Proxy do
    it "Malformed payload when tx is not binary" do
      ...
      no_binary_blob = "test"
      res = BccWallet.new.misc.proxy.submit_external_transaction(no_binary_blob)
      expect(res).to be_correct_and_respond 400
      expect(res.to_s).to include "malformed_tx_payload"
    end
  end

  describe BccWallet::Misc::Settings do
