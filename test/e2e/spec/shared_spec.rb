RSpec.describe BccWallet::Shared do

  describe BccWallet::Shared::Wallets do
    ...
    describe "Create wallets" do
      it "I can create, get and delete wallet from mnemonics getting acc_xpub from bcc-address" do
        w = SHARED.wallets

        m24 = mnemonic_sentence(24)
        acc_ix = '0H'
        acc_xpub = bcc_address_get_acc_xpub(m24, "1854H/1815H/#{acc_ix}")
      ...
      it "I can create, get and delete wallet from pub key getting acc_xpub from bcc-address" do
        w = SHARED.wallets
      ...
      it "Cannot create wallet with different acc xpub - derived from different mnemonic sentence" do
        ...
        m24 = mnemonic_sentence(24)
        acc_ix = '0H'
        acc_xpub_wrong = bcc_address_get_acc_xpub(mnemonic_sentence(24),
                                                              "1854H/1815H/0H")
      ...
      it "Cannot create wallet with different acc xpub - derived from different acc ix" do
        ...
        m24 = mnemonic_sentence(24)
        acc_ix = '0H'
        acc_xpub_wrong = bcc_address_get_acc_xpub(m24, "1854H/1815H/255H")
      ...
      it "I can create incomplete wallet and update cosigners with acc_xpub from bcc-address" do
        m24 = mnemonic_sentence(24)
        acc_xpub = bcc_address_get_acc_xpub(m24, "1854H/1815H/0H")
        incomplete_wid = create_incomplete_shared_wallet(m24, '0H', acc_xpub)

        acc_xpub_upd = bcc_address_get_acc_xpub(mnemonic_sentence(24),
                                                "1854H/1815H/0H")
    ...
    describe "Account Public Keys" do
      it "Create account public key - incomplete wallet from mnemonics" do
        ...
        acc_xpub = bcc_address_get_acc_xpub(m24, der_path)
        incomplete_wid = create_incomplete_shared_wallet(m24, '0H', acc_xpub)
