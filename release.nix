...
#   https://hydra.tbco.io/jobset/Bcc/bcc-wallet#tabs-jobs
#
...
# The project sources
{ bcc-wallet ? { outPath = ./.; rev = pkgs.commonLib.commitIdFromGitRepoOrZero ./.git; }
...
let
  ...
  platformJobs = optionalAttrs buildLinux (with releaseLib.linux; rec {
    ...
    bcc-wallet-linux64 = import ./nix/release-package.nix {
      inherit pkgs;
    ...
    bcc-wallet-macos64 = hydraJob' (import ./nix/release-package.nix {
    ...
    bcc-wallet-win64 = import ./nix/release-package.nix {
      inherit pkgs;
    ...
    bcc-wallet-tests-win64 = import ./nix/windows-testing-bundle.nix {
      inherit pkgs project;
      bcc-wallet = windows.bcc-wallet;
      bcc-node = windows.bcc-node;
      bcc-cli = windows.bcc-cli;
  ...
  filterJobs = {
    ...
    windows = makeJobFilter filterJobsCross {
      # Remove bcc-node integration tests for Windows because
      # shardagnostic-network doesn't work under wine.
      checks.bcc-wallet.integration = [];
