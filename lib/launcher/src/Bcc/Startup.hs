...
#ifdef WINDOWS
import Bcc.Startup.Windows
#else
import Bcc.Startup.POSIX
#endif
...
--
-- This is necessary when running bcc-wallet as a subprocess of Klarity.
-- For more details, see
-- <https://github.com/The-Blockchain-Company/bcc-launcher/blob/master/docs/windows-clean-shutdown.md>
--
...
--
-- So, when running @bcc-wallet@ as a subprocess, the parent process should
-- pass a pipe for 'stdin', then close the pipe when it wants @bcc-wallet@
-- to shut down.
