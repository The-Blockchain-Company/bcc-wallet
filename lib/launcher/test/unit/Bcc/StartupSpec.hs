...
-- Example: https://github.com/The-Blockchain-Company/shardagnostic-network/blob/69d62063e59f966dc90bda5b4d0ac0a11efd3657/Win32-network/src/System/Win32/Async/Socket.hs#L46-L59
wrapIO :: IO a -> IO a
#if defined(WINDOWS)
wrapIO action = do
