...
--
-- >>> a :: Word32 -- in entropic
--
-- we can write
--
-- >>> a :: Quantity "entropic" Word32
--
-- which now has a different type from
--
-- >>> b :: Quantity "entropic/byte" Word32
--
...
--
-- >>> Aeson.encode $ Quantity @"entropic" 14
-- {"unit":"entropic","quantity":14}
...
-- Builds (Quantity "entropic" Word64) as "42 entropic"
