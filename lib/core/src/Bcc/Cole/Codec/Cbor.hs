...
-- themselves).
--
-- The format described in the decoders below are the one used in the Cole era
-- of Bcc and will endure in the first stages of Sophie. They are also used
-- by components like the Rust <https://github.com/The-Blockchain-Company/bcc-http-bridge bcc-http-bridge>.

module Bcc.Cole.Codec.Cbor
    (
    -- * Decoding
