...
--
-- It is assumed that all bcc-wallet packages have the same version, that of
-- the core package.
--
...
-- revision of the @bcc-wallet@ binary can be updated post-build using
