...
-- License: Apache-2.0
--
-- Implementation of address derivation for 'Icarus' keys. This uses the Cole
-- derivation for addresses, but on top of the derivation scheme V2.

module Bcc.Wallet.Primitive.AddressDerivation.Icarus
    ( -- * Types
      IcarusKey(..)
...
import Bcc.Wallet.Primitive.AddressDiscovery.Sequential
    ( SeqState, coinTypeBcc, purposeBIP44 )
