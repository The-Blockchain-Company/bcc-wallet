...
module Bcc.Wallet.Primitive.AddressDiscovery
    (
    -- * Abstractions
      IsOurs(..)
    , IsOwned(..)
...
--
-- This is needed because two different address schemes lives on Bcc:
--
...
coinTypeBcc :: Index 'Hardened 'CoinTypeK
coinTypeBcc = toEnum 0x80000717
