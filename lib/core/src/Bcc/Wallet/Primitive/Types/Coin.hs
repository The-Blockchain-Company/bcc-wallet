...
-- entropic.
--
module Bcc.Wallet.Primitive.Types.Coin
    ( -- * Type
      Coin (..)
    , coinQuantity
    , coinToInteger
...
-- | A 'Coin' represents a quantity of entropic.
--
-- Reminder: 1 bcc = 1,000,000 entropic.
--
-- NOTE: The 'Coin' value is stored as a 64-bit unsigned integer. The maximum
-- supply of entropic is less than 2^56, so there is ample space to store any
-- circulating amount of Bcc.
--
...
-- | Whether the coin amount is less than the total amount of Bcc.
...
-- the vast majority of usages of this function within bcc-wallet, it is a
-- safe operation.
--
