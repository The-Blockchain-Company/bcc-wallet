...
-- @Bcc.Wallet.ApiSpec@ to generically derive a set of unit tests from the
...
module Bcc.Wallet.Api.Malformed
    (
    -- * Data Types
      Header (..)
    , PathParam (..)
...
instance Malformed (BodyParam ApiWalletSignData) where
    malformed = first BodyParam <$>
        ...
        , ( Aeson.encode [aesonQQ|
          ...
          , "Error in $: parsing Bcc.Wallet.Api.Types.ApiWalletSignData(ApiWalletSignData) failed, key 'passphrase' not found"
          )
        , ( Aeson.encode [aesonQQ|
            { "passphrase": #{wPassphrase}
            }|]
          , "Error in $: parsing Bcc.Wallet.Api.Types.ApiWalletSignData(ApiWalletSignData) failed, key 'metadata' not found"
          )
        ]
...
instance Malformed (BodyParam SomeColeWalletPostData) where
    malformed = jsonValid ++ jsonInvalid
     where
         jsonInvalid = first BodyParam <$>
            [ ("1020344", "Error in $: parsing SomeColeWallet failed, expected Object, but encountered Number")
            , ("\"1020344\"", "Error in $: parsing SomeColeWallet failed, expected Object, but encountered String")
         ...
         jsonValid = first (BodyParam . Aeson.encode) <$>
            ...
            , ( [aesonQQ|
              ...
              , "Error in $['mnemonic_sentence']: Found an unknown word not present in the pre-defined dictionary. The full dictionary is available here: https://github.com/The-Blockchain-Company/bcc-wallet/tree/master/specifications/mnemonic/english.txt"
              )
            , ( [aesonQQ|
                { "style": "trezor"
                , "name": #{wName}
            ...
            , ( [aesonQQ|
              ...
              , "Error in $: parsing Bcc.Wallet.Api.Types.ColeWalletPostData(ColeWalletPostData) failed, key 'passphrase' not found"
              )
            ]
     ...
     where
         ...
         jsonValid = first (BodyParam . Aeson.encode) <$>
            ...
            , ( [aesonQQ|
              ...
              , "Error in $: parsing Bcc.Wallet.Api.Types.WalletPostData(WalletPostData) failed, key 'mnemonic_sentence' not found"
              )
            , ( [aesonQQ|
                { "name": #{wName}
                , "mnemonic_sentence": []
            ...
            , ( [aesonQQ|
              ...
              , "Error in $: parsing Bcc.Wallet.Api.Types.WalletPostData(WalletPostData) failed, key 'name' not found"
              )
            -- address_pool_gap
            , ( [aesonQQ|
                { "name": #{wName}
            ...
            , ( [aesonQQ|
              ...
              , "Error in $: parsing Bcc.Wallet.Api.Types.WalletPostData(WalletPostData) failed, key 'passphrase' not found"
              )
...
instance Malformed (BodyParam WalletPutPassphraseData) where
    malformed = jsonValid ++ jsonInvalid
     where
         jsonInvalid = first BodyParam <$>
            [ ("1020344", "Error in $: parsing Bcc.Wallet.Api.Types.WalletPutPassphraseData(WalletPutPassphraseData) failed, expected Object, but encountered Number")
            , ("\"1020344\"", "Error in $: parsing Bcc.Wallet.Api.Types.WalletPutPassphraseData(WalletPutPassphraseData) failed, expected Object, but encountered String")
            , ("\"slot_number : \"random\"}", "trailing junk after valid JSON: endOfInput")
         ...
         jsonValid = first (BodyParam . Aeson.encode) <$>
            ...
            , ( [aesonQQ|
              ...
              , "Error in $: parsing Bcc.Wallet.Api.Types.WalletPutPassphraseData(WalletPutPassphraseData) failed, key 'new_passphrase' not found"
              )
            , ( [aesonQQ|
                { "new_passphrase": #{wPassphrase}
                }|]
              , "Error in $: parsing Bcc.Wallet.Api.Types.WalletPutPassphraseData(WalletPutPassphraseData) failed, key 'old_passphrase' not found"
              )
            ]

instance Malformed (BodyParam ColeWalletPutPassphraseData) where
    malformed = jsonValid ++ jsonInvalid
     where
         jsonInvalid = first BodyParam <$>
            [ ("1020344", "Error in $: parsing Bcc.Wallet.Api.Types.ColeWalletPutPassphraseData(ColeWalletPutPassphraseData) failed, expected Object, but encountered Number")
            , ("\"1020344\"", "Error in $: parsing Bcc.Wallet.Api.Types.ColeWalletPutPassphraseData(ColeWalletPutPassphraseData) failed, expected Object, but encountered String")
            , ("\"slot_number : \"random\"}", "trailing junk after valid JSON: endOfInput")
            , ("{old_passphrase = \"random\"}", msgJsonInvalid)
            ]
         jsonValid = first (BodyParam . Aeson.encode) <$>
            ...
            , ( [aesonQQ|
              ...
              , "Error in $: parsing Bcc.Wallet.Api.Types.ColeWalletPutPassphraseData(ColeWalletPutPassphraseData) failed, key 'new_passphrase' not found"
              )
            ]
...
instance Malformed (BodyParam WalletPutData) where
    malformed = jsonValid ++ jsonInvalid
     where
         jsonInvalid = first BodyParam <$>
            [ ("1020344", "Error in $: parsing Bcc.Wallet.Api.Types.WalletPutData(WalletPutData) failed, expected Object, but encountered Number")
            , ("\"1020344\"", "Error in $: parsing Bcc.Wallet.Api.Types.WalletPutData(WalletPutData) failed, expected Object, but encountered String")
            , ("\"slot_number : \"random\"}", "trailing junk after valid JSON: endOfInput")
...
instance Malformed (BodyParam ApiWalletPassphrase) where
    malformed = jsonValid ++ jsonInvalid
     where
         jsonInvalid = first BodyParam <$>
            [ ("1020344", "Error in $: parsing Bcc.Wallet.Api.Types.ApiWalletPassphrase(ApiWalletPassphrase) failed, expected Object, but encountered Number")
            , ("\"1020344\"", "Error in $: parsing Bcc.Wallet.Api.Types.ApiWalletPassphrase(ApiWalletPassphrase) failed, expected Object, but encountered String")
            , ("\"slot_number : \"random\"}", "trailing junk after valid JSON: endOfInput")
            , ("{\"name : \"random\"}", msgJsonInvalid)
            ]
         jsonValid = first (BodyParam . Aeson.encode) <$>
...
instance Malformed (BodyParam ApiPostAccountKeyData) where
    malformed = jsonValid ++ jsonInvalid
     where
         jsonInvalid = first BodyParam <$>
            [ ("1020344", "Error in $: parsing Bcc.Wallet.Api.Types.ApiPostAccountKeyData(ApiPostAccountKeyData) failed, expected Object, but encountered Number")
            , ("\"1020344\"", "Error in $: parsing Bcc.Wallet.Api.Types.ApiPostAccountKeyData(ApiPostAccountKeyData) failed, expected Object, but encountered String")
            , ("\"slot_number : \"random\"}", "trailing junk after valid JSON: endOfInput")
            , ("{\"name : \"random\"}", msgJsonInvalid)
            ]
         jsonValid = first (BodyParam . Aeson.encode) <$>
            ...
            , ( [aesonQQ| { "format": "extended" }|]
              , "Error in $: parsing Bcc.Wallet.Api.Types.ApiPostAccountKeyData(ApiPostAccountKeyData) failed, key 'passphrase' not found"
              )
            , ( [aesonQQ| { "passphrase": "The proper passphrase" }|]
              , "Error in $: parsing Bcc.Wallet.Api.Types.ApiPostAccountKeyData(ApiPostAccountKeyData) failed, key 'format' not found"
              )
            , ( [aesonQQ| { "passphrase": "The proper passphrase", "format": 123 }|]
              , "Error in $.format: parsing Bcc.Wallet.Api.Types.KeyFormat failed, expected String, but encountered Number"
              )
            , ( [aesonQQ| { "passphrase": "The proper passphrase", "format": [] }|]
              , "Error in $.format: parsing Bcc.Wallet.Api.Types.KeyFormat failed, expected String, but encountered Array"
              )
            , ( [aesonQQ| { "passphrase": "The proper passphrase", "format": 1.5 }|]
              , "Error in $.format: parsing Bcc.Wallet.Api.Types.KeyFormat failed, expected String, but encountered Number"
              )
            , ( [aesonQQ| { "passphrase": "The proper passphrase", "format": "ok" }|]
              , "Error in $.format: parsing Bcc.Wallet.Api.Types.KeyFormat failed, expected one of the tags ['extended','non_extended'], but found tag 'ok'"
              )
            ]
...
instance Malformed (BodyParam ApiPostAccountKeyDataWithPurpose) where
    malformed = jsonValid ++ jsonInvalid
     where
         jsonInvalid = first BodyParam <$>
            [ ("1020344", "Error in $: parsing Bcc.Wallet.Api.Types.ApiPostAccountKeyDataWithPurpose(ApiPostAccountKeyDataWithPurpose) failed, expected Object, but encountered Number")
            , ("\"1020344\"", "Error in $: parsing Bcc.Wallet.Api.Types.ApiPostAccountKeyDataWithPurpose(ApiPostAccountKeyDataWithPurpose) failed, expected Object, but encountered String")
            , ("\"slot_number : \"random\"}", "trailing junk after valid JSON: endOfInput")
            , ("{\"name : \"random\"}", msgJsonInvalid)
            ]
         jsonValid = first (BodyParam . Aeson.encode) <$>
            ...
            , ( [aesonQQ| { "format": "extended" }|]
              , "Error in $: parsing Bcc.Wallet.Api.Types.ApiPostAccountKeyDataWithPurpose(ApiPostAccountKeyDataWithPurpose) failed, key 'passphrase' not found"
              )
            , ( [aesonQQ| { "passphrase": "The proper passphrase" }|]
              , "Error in $: parsing Bcc.Wallet.Api.Types.ApiPostAccountKeyDataWithPurpose(ApiPostAccountKeyDataWithPurpose) failed, key 'format' not found"
              )
            , ( [aesonQQ| { "passphrase": "The proper passphrase", "format": 123 }|]
              , "Error in $.format: parsing Bcc.Wallet.Api.Types.KeyFormat failed, expected String, but encountered Number"
              )
...
instance Malformed (BodyParam ApiSignTransactionPostData) where
    malformed = jsonValid ++ jsonInvalid
     where
         jsonInvalid = first BodyParam <$>
            [ ("1020344", "Error in $: parsing Bcc.Wallet.Api.Types.ApiSignTransactionPostData(ApiSignTransactionPostData) failed, expected Object, but encountered Number")
            , ("\"hello\"", "Error in $: parsing Bcc.Wallet.Api.Types.ApiSignTransactionPostData(ApiSignTransactionPostData) failed, expected Object, but encountered String")
         ...
         jsonValid = first (BodyParam . Aeson.encode) <$>
            ...
            , ( [aesonQQ|
              ...
              , "Error in $: parsing Bcc.Wallet.Api.Types.ApiSignTransactionPostData(ApiSignTransactionPostData) failed, key 'passphrase' not found"
              )
            , ( [aesonQQ|
               { "transaction": #{validSealedTxBase64},
                  "passphrase": #{nameTooLong}
            ...
            , ( [aesonQQ|
               ...
               , "Error in $: parsing Bcc.Wallet.Api.Types.ApiSignTransactionPostData(ApiSignTransactionPostData) failed, unknown fields: ['extra']"
              )
            ]
...
instance Malformed (BodyParam (PostTransactionOldData ('Testnet pm))) where
    malformed = jsonValid ++ jsonInvalid
     where
         jsonInvalid = first BodyParam <$>
            [ ("1020344", "Error in $: parsing Bcc.Wallet.Api.Types.PostTransactionOldData(PostTransactionOldData) failed, expected Object, but encountered Number")
            , ("\"1020344\"", "Error in $: parsing Bcc.Wallet.Api.Types.PostTransactionOldData(PostTransactionOldData) failed, expected Object, but encountered String")
            , ("{\"payments : [], \"random\"}", msgJsonInvalid)
            ]
         jsonValid = first (BodyParam . Aeson.encode) <$> paymentCases ++
            [ -- passphrase
              ...
              , "Error in $: parsing Bcc.Wallet.Api.Types.PostTransactionOldData(PostTransactionOldData) failed, key 'passphrase' not found"
              )
            , ( [aesonQQ|
               { "payments": [
                   {
...
instance Malformed (BodyParam (PostTransactionFeeOldData ('Testnet pm))) where
    malformed = jsonValid ++ jsonInvalid
     where
         jsonInvalid = first BodyParam <$>
            [ ("1020344", "Error in $: parsing Bcc.Wallet.Api.Types.PostTransactionFeeOldData(PostTransactionFeeOldData) failed, expected Object, but encountered Number")
            , ("\"1020344\"", "Error in $: parsing Bcc.Wallet.Api.Types.PostTransactionFeeOldData(PostTransactionFeeOldData) failed, expected Object, but encountered String")
            , ("{\"payments : [], \"random\"}", msgJsonInvalid)
            , ("\"slot_number : \"random\"}", "trailing junk after valid JSON: endOfInput")
            ]
         jsonValid = first (BodyParam . Aeson.encode) <$> paymentCases
...
instance Malformed (BodyParam (ApiConstructTransactionData ('Testnet pm))) where
    malformed = jsonValid ++ jsonInvalid
     where
         jsonInvalid = first BodyParam <$>
            [ ("1020344", "Error in $: parsing Bcc.Wallet.Api.Types.ApiConstructTransactionData(ApiConstructTransactionData) failed, expected Object, but encountered Number")
            , ("\"1020344\"", "Error in $: parsing Bcc.Wallet.Api.Types.ApiConstructTransactionData(ApiConstructTransactionData) failed, expected Object, but encountered String")
            , ("{\"payments : [], \"random\"}", msgJsonInvalid)
            ]
         jsonValid = first (BodyParam . Aeson.encode) <$> paymentCases ++
            [
            ...
            , ( [aesonQQ|
               ...
               , "Error in $['validity_interval']: parsing Bcc.Wallet.Api.Types.ApiValidityInterval(ApiValidityInterval) failed, key 'invalid_hereafter' not found"
              )
            , ( [aesonQQ|
                {
                    "metadata": { "1": { "string": "hello" } },
               ...
               , "Error in $['validity_interval']: parsing Bcc.Wallet.Api.Types.ApiValidityInterval(ApiValidityInterval) failed, key 'invalid_before' not found"
              )
            , ( [aesonQQ|
                  {
                    "payments": [{
            ...
            , ( [aesonQQ|{"withdrawal":["word,","word,","word,","word,","word,","word,","word,","word,","word,","word,","word,","word,","word,","word,","word,"]}|]
               , "Error in $.withdrawal: Found an unknown word not present in the pre-defined dictionary. The full dictionary is available here: https://github.com/The-Blockchain-Company/bcc-wallet/tree/master/specifications/mnemonic/english.txt"
              )
            ]
...
instance Malformed (BodyParam (ApiWalletMigrationPlanPostData ('Testnet pm))) where
    malformed = jsonValid ++ jsonInvalid
     where
         jsonInvalid = first BodyParam <$>
            [ ("1020344", "Error in $: parsing Bcc.Wallet.Api.Types.ApiWalletMigrationPlanPostData(ApiWalletMigrationPlanPostData) failed, expected Object, but encountered Number")
            , ("\"1020344\"", "Error in $: parsing Bcc.Wallet.Api.Types.ApiWalletMigrationPlanPostData(ApiWalletMigrationPlanPostData) failed, expected Object, but encountered String")
            , ("{\"payments : [], \"random\"}", msgJsonInvalid)
            , ("\"slot_number : \"random\"}", "trailing junk after valid JSON: endOfInput")
            ]
...
instance Malformed (BodyParam (ApiWalletMigrationPostData ('Testnet pm) "lenient")) where
    malformed = jsonValid ++ jsonInvalid
     where
         jsonInvalid = first BodyParam <$>
            [ ("1020344", "Error in $: parsing Bcc.Wallet.Api.Types.ApiWalletMigrationPostData(ApiWalletMigrationPostData) failed, expected Object, but encountered Number")
            , ("\"1020344\"", "Error in $: parsing Bcc.Wallet.Api.Types.ApiWalletMigrationPostData(ApiWalletMigrationPostData) failed, expected Object, but encountered String")
            , ("{\"payments : [], \"random\"}", msgJsonInvalid)
            , ("\"slot_number : \"random\"}", "trailing junk after valid JSON: endOfInput")
            ]
...
instance Malformed (BodyParam (ApiPutAddressesData ('Testnet pm))) where
    malformed = jsonValid ++ jsonInvalid
     where
         jsonInvalid = first BodyParam <$>
            [ ("1020344", "Error in $: parsing Bcc.Wallet.Api.Types.ApiPutAddressesData(ApiPutAddressesData) failed, expected Object, but encountered Number")
            , ("\"1020344\"", "Error in $: parsing Bcc.Wallet.Api.Types.ApiPutAddressesData(ApiPutAddressesData) failed, expected Object, but encountered String")
            , ("{\"payments : [], \"random\"}", msgJsonInvalid)
            , ("\"slot_number : \"random\"}", "trailing junk after valid JSON: endOfInput")
            ]
...
instance Malformed (BodyParam ApiSlotReference) where
    malformed = jsonValid ++ jsonInvalid
     where
         jsonInvalid = first BodyParam <$>
            [ ("1020344", "Error in $: parsing Bcc.Wallet.Api.Types.ApiSlotReference(ApiSlotReference) failed, expected Object, but encountered Number")
            , ("\"1020344\"", "Error in $: parsing Bcc.Wallet.Api.Types.ApiSlotReference(ApiSlotReference) failed, expected Object, but encountered String")
         ...
         jsonValid = first (BodyParam . Aeson.encode) <$>
            ...
            , ( [aesonQQ|
              ...
              , "Error in $: parsing Bcc.Wallet.Api.Types.ApiSlotReference(ApiSlotReference) failed, key 'epoch_number' not found"
              )
            , ( [aesonQQ|
                { "epoch_number": 0
                }|]
              , "Error in $: parsing Bcc.Wallet.Api.Types.ApiSlotReference(ApiSlotReference) failed, key 'slot_number' not found"
              )
            ]
...
instance Malformed (BodyParam (ApiT SealedTx)) where
    malformed = first BodyParam <$>
        [ ("", "DecoderErrorDeserialiseFailure 'Sophie Tx' (DeserialiseFailure 0 'end of input')")
        , ("cafecafe", "DecoderErrorDeserialiseFailure 'Sophie Tx' (DeserialiseFailure 0 'expected list len or indef')")
        ]
...
instance Malformed (BodyParam ApiPostRandomAddressData) where
    malformed = first (BodyParam . Aeson.encode) <$>
        ...
        , ( [aesonQQ|
          ...
          , "Error in $: parsing Bcc.Wallet.Api.Types.ApiPostRandomAddressData(ApiPostRandomAddressData) failed, key 'passphrase' not found"
          )
        ]
...
instance Malformed (BodyParam ApiMaintenanceActionPostData) where
    malformed = first (BodyParam . Aeson.encode) <$>
        [ ( [aesonQQ|
          ...
          , "Error in $['maintenance_action']: parsing Bcc.Wallet.Api.Types.MaintenanceAction failed, expected one of the tags ['gc_stake_pools'], but found tag 'unknown_action'"
          )
        ]
...
paymentCases =
    ...
    , ( [aesonQQ|
      ...
      , "Error in $.payments[0].amount: parsing AddressAmount failed, failed to parse quantified value. Expected value in 'entropic' (e.g. { 'unit': 'entropic', 'quantity': ... }) but got something else."
      )
    , ( [aesonQQ|
        { "payments": [
            {
...
migrateDataCases =
    ...
    , ( [aesonQQ|
      ...
      , "Error in $: parsing Bcc.Wallet.Api.Types.ApiWalletMigrationPostData(ApiWalletMigrationPostData) failed, key 'addresses' not found"
      )
    , ( [aesonQQ|
        { "addresses": 1
        }|]
      , "Error in $: parsing Bcc.Wallet.Api.Types.ApiWalletMigrationPostData(ApiWalletMigrationPostData) failed, key 'passphrase' not found"
      )
    , ( [aesonQQ|
        { "passphrase": 1
...
createMigrationPlanDataCases =
    ...
    , ( [aesonQQ|
        {}|]
      , "Error in $: parsing Bcc.Wallet.Api.Types.ApiWalletMigrationPlanPostData(ApiWalletMigrationPlanPostData) failed, key 'addresses' not found"
      )
    ]
...
putAddressesDataCases =
    ...
    , ( [aesonQQ|
      ...
      , "Error in $: parsing Bcc.Wallet.Api.Types.ApiPutAddressesData(ApiPutAddressesData) failed, key 'addresses' not found"
      )
    ]
...
instance Malformed (BodyParam (PostMintBurnAssetData ('Testnet pm))) where
    malformed = jsonValid ++ jsonInvalid
     where
         jsonInvalid = first BodyParam <$>
            [ ("1020344", "Error in $: parsing Bcc.Wallet.Api.Types.PostMintBurnAssetData(PostMintBurnAssetData) failed, expected Object, but encountered Number")
            , ("\"1020344\"", "Error in $: parsing Bcc.Wallet.Api.Types.PostMintBurnAssetData(PostMintBurnAssetData) failed, expected Object, but encountered String")
         ...
         jsonValid = first (BodyParam . Aeson.encode) <$>
            ...
            , ( [aesonQQ|
              ...
              , "Error in $['mint_burn'][0].operation.mint: parsing Bcc.Wallet.Api.Types.ApiMintData(ApiMintData) failed, key 'receiving_address' not found"
              )
            , ( [aesonQQ|
                { "mint_burn": [{ "monetary_policy_index": "0"
                                , "asset_name": "deadbeef"
